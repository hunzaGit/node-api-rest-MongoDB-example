...
exports.sendEmail = function (req, res, callback = Function()) {
    ...
    var content = new helper.Content('text/HTML', "<html><body>Holaa Rodri,<br>" +
        "Esto es una prueba de email desde <img src='https://upload.wikimedia.org/wikipedia/commons/8/89/Logo_di_Heroku.png'  width='150' height='50' alt=''HerokuLogo> " +
        "con texto escrito en <b>HTML</b> usando el Add-On <img src='https://avatars3.githubusercontent.com/u/181234?v=4&s=200' width='100' height='100'>, " +
         "y esta es la foto de mi careto <br>"+
            "<img align='center' src='http://s2.quickmeme.com/img/f2/f22c50f29387e1461274eb73ae3a329e97e3aa09ac8dffee9218e017cd6c8b99.jpg' width='360' height='200'>");
